          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                onChange={handleChange}
                className="w-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/10 rounded-md py-4 px-4 text-neutral-800 dark:text-neutral-300 focus:outline-none focus:border-brand-accent transition-colors appearance-none cursor-pointer hover:border-brand-accent/30"
              >
